...
public class FormPage2 {
    ...
    @FindBy(how = How.XPATH, using = "//span/input[@value=\"RC\"]")
    ...
    public void firstName(String fname){
        Fname_Locator.sendKeys(fname+ Basepage.randomNumGenerator());
    }
